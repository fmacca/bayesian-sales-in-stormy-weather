...
head(data.out_wish)
save(data.out_wish,list="data.out_wish",file="output/data.out_wish.RData")

alpha.post <- data.out_wish[,1:25]
beta.post <- data.out_wish[,26:50]
sigma.post <- data.out_wish[,51:75]
ystar.post <- data.out_wish[,76:125]
...
testdates=ar1data$date[(n.train+1):(n.train+n.test)]
x11()
